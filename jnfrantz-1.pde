...
void keyPressed() 
{
  ...
  // ISSUES: holding down the spacebar causes clicking again
...
void create_arrow() {
  strokeWeight(4);
  stroke(255,255,0); // TODO: dynamic color?
  
  int x1 = mouseX;
  int y1 = mouseY;
  
  int x2 = getButtonX(trials.get(trialNum));
  int y2 = getButtonY(trials.get(trialNum));
